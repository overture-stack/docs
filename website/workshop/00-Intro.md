...
<details>
<summary><strong>4. Repository cloned:</strong> `git clone -b ISBWorkshop https://github.com/overture-stack/prelude.git`</summary>
...
```bash
git clone -b ISBWorkshop https://github.com/overture-stack/prelude.git
```
