...
const products: Product[] = [
  ...
  { title: 'Lectern', link: '/docs/under-development/lyric/', description: 'Schema Management Service', category: 'development' },
  { title: 'Lyric', link: '/docs/under-development/lectern/', description: 'Tabular Data Submission Service', category: 'development' },
