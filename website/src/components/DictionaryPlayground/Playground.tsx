		...
		<div className={styles.playground}>
			...
			<div className={styles.header}>
				<div>
					...
					<p className={styles.subtitle}>
						Edit a Lectern dictionary above; see it rendered live below. For the full field and
						restriction reference, see{' '}
						<a href="/develop/Lectern/dictionaryReference" target="_blank" rel="noopener noreferrer">
			...
			<div className={styles.stack}>
				...
				<div className={styles.editorPanel}>
					...
					<div className={styles.editorToolbar}>
						...
						<div className={styles.toolbarButtons}>
							{[
								...
								<button type="button" key={label} className={styles.ghostButton} onClick={onClick}>
									{label}
								</button>
							))}
						</div>
					...
					>
						{parseResult.status === 'valid' ? (
							<div className={styles.statusValidText}>Valid Lectern dictionary</div>
						) : parseResult.status === 'warning' ? (
