// Starter and demo Lectern dictionaries for the embedded Dictionary Playground.
// Extracted verbatim from the Prelude IBCworkshop stage app (DictionaryPlayground.tsx).
