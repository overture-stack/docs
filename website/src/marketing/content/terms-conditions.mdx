<!--
  Prose for the /terms-conditions/ route. Imported by
  src/pages/terms-conditions/index.tsx, which owns the route, the hero and the
  page metadata; this file is only the words. It lives outside src/pages/ on
  purpose: anything under there becomes a route.

  Plain Markdown, editable without touching React. `##` renders as a section
  heading with its yellow rule underneath, from .TermsConditionsPage in
  src/marketing/styles/pages/_terms-conditions.scss. Do not add a `#`: the page
  heading comes from the hero.

  Section numbers are typed here, as `## **4** Title`. They are deliberately not
  a CSS counter: generated content cannot be selected or copied, and these get
  cited by number. If you reorder sections, renumber them by hand.
-->

**May 16, 2018:** Thank you for visiting the Overture website. Please read the Terms and Conditions carefully before using this website.

## **1** Terms & Conditions of Use of Site
...
The [Website Privacy Statement](/privacy/) applies to your use of this website. Please ensure you have read and agree with the [Website Privacy Statement](/privacy/). By visiting and using this Site, you are consenting to the collection, use and disclosure of your Personal Information while visiting the Site.
