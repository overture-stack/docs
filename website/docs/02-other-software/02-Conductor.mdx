...
<Tabs>
  ...
  <TabItem value="scoreDev" label="ScoreDev">
     ![ScoreDev](./images/scoreDev.svg 'Score Dev Environment')
  </TabItem>
  <TabItem value="maestroDev" label="MaestroDev">
     ![MaestroDev](./images/maestroDev.svg 'Maestro Dev Environment')
  </TabItem>
  <TabItem value="arrangerDev" label="ArrangerDev">
     ![ArrangerDev](./images/arrangerDev.svg 'Arranger Dev Environment')
  </TabItem>
  <TabItem value="stageDev" label="StageDev">
    ![StageDev](./images/stageDev.svg 'Stage Dev Environment')
  </TabItem>
</Tabs>
