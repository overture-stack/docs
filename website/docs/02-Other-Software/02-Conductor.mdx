...
<Tabs>
  ...
  <TabItem value="songDev" label="SongDev">
     ![Score Dev](../01-Core-Products/01-Song/assets/songDev.svg 'Song Dev Environment')
  </TabItem>
  <TabItem value="scoreDev" label="ScoreDev">
     ![Score Dev](../01-Core-Products/02-Score/assets/scoreDev.svg 'Score Dev Environment')
  </TabItem>
  <TabItem value="maestroDev" label="MaestroDev">
     ![Maestro Dev](../01-Core-Products/03-Maestro/assets/maestroDev.svg 'Maestro Dev Environment')
  </TabItem>
  <TabItem value="arrangerDev" label="ArrangerDev">
     ![Arranger Dev](../01-Core-Products/04-Arranger/assets/arrangerDev.svg 'Arranger Dev Environment')
  </TabItem>
  <TabItem value="stageDev" label="StageDev">
    ![Stage Dev](../01-Core-Products/05-Stage/assets/stageDev.svg 'Stage Dev Environment')
  </TabItem>
</Tabs>
