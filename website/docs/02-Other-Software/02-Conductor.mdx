...
<Tabs>
  ...
  <TabItem value="songDev" label="SongDev">
     ![SongDev](../01-Core-Products/01-Song/assets/song_dev.svg 'Song Dev Environment')
  </TabItem>
  <TabItem value="scoreDev" label="ScoreDev">
     ![ScoreDev](../01-Core-Products/02-Score/assets/scoreDev.svg 'Score Dev Environment')
  </TabItem>
  <TabItem value="maestroDev" label="MaestroDev">
     ![MaestroDev](../01-Core-Products/03-Maestro/assets/maestroDev.svg 'Maestro Dev Environment')
  </TabItem>
  <TabItem value="arrangerDev" label="ArrangerDev">
     ![ArrangerDev](../01-Core-Products/04-Arranger/assets/arrangerDev.svg 'Arranger Dev Environment')
  </TabItem>
  <TabItem value="stageDev" label="StageDev">
    ![StageDev](../01-Core-Products/05-Stage/assets/stageDev.svg 'Stage Dev Environment')
  </TabItem>
</Tabs>
