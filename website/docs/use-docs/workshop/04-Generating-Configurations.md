...
:::tip
For a full reference on `extended.json`, see the [Arranger extended configuration docs](/develop/Arranger/reference/arranger-configs#extendedjson).
:::
...
:::tip
For a full reference on `table.json`, see the [Arranger table configuration docs](/develop/Arranger/reference/arranger-configs#tablejson).
:::
...
:::tip
For a full reference on `facets.json`, see the [Arranger facet configuration docs](/develop/Arranger/reference/arranger-configs#facetsjson).
:::
